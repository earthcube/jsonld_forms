...
//   rtypes = rtypes.concat(spectype).concat(semrestype)
  ...
  // anyOf mucks up the interface.
  jsonschema.properties.mainEntity.items.oneOf = rtypes.oneOf;
  // I think these are best handled by template documents.
  // where the template would be configured for the specification.
  // otherwise it's a new resourceType_semantic_subtype, every time on is created.
