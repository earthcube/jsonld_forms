const resourceType = {
  ...
  elements: [
      { type: 'Label',
          // show this message if the resource type is the generic semantic resource
          // rule: {
          //     effect: 'SHOW',
          //     condition: {
          //         scope: '#/properties/mainEntity/',
       ...
       text: 'Note that more specific sub types for semantic resource can be selected;' +
           ' these include: Glossary;  Thesaurus; Ontology; Controlled Vocabulary; ' +
           'Taxonomy; Conceptual Model; RDF Vocabulary; SKOS Vocabulary. ' +
