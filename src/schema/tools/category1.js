      ...
      elements: [
        {
          type: 'Label',
          text:
            "1.1.1 Short Name for the <span style='color:peru;'>Resource</span>",
          ...
          elements: [
            {
              type: 'Label',
              text:
                "1.1.2 <span style='color:peru;'> Identifier </span> Readonly"
            },
            {
              label: 'Identifier',
              type: 'Control',
...

        {
          ...
          elements: [
            ...
            },
            {
              type: 'Control',
              label:
                'Publication Date of Most Recent Release. This will be formated at YYYY-MM-DD in the output',
