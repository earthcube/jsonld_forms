...
const jsonschema = {
  ...
  properties: {
    ...
    subjectOf: {
      ...
      description:
        'Name and url for one or more web pages or other web accessible document about the resource',
      type: 'array',
      items: {
    ...
    funder: {
      description:
        'could be one funding agency or organization, or an array with items that can be agents (person or organization) or Grants; grants have a funding agency',
      type: 'array',
      items: {
        anyOf: [
          {
    ...
    mainEntity: {
      ...
      description:
        'url is URI for ECRR resource type; name is ECRR resource type name. This should include the ECRR URI; it is used to validate resource specific properties'
      //"type": "Object",
      // "uniqueItems": true,
      //       "items": {
